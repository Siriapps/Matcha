...
function Signup() {
  ...
  // Handle Auth0 redirect after signup - redirect to profile setup
  useEffect(() => {
    if (auth0IsAuthenticated && auth0User) {
      // For new signups via Auth0, always redirect to profile setup step 1
      // The profile setup pages will check if user already completed setup
      navigate('/profile/step1', { replace: true })
    }
  }, [auth0IsAuthenticated, auth0User, navigate])
  ...
  const handleSignup = async (e) => {
    ...
    if (result.success) {
      // Redirect new users to profile setup step 1
      navigate('/profile/step1', { replace: true })
    } else {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-6xl overflow-hidden">
        <div className="grid md:grid-cols-2 min-h-[700px]">
          ...
          <div className="p-8 md:p-12 bg-white flex flex-col justify-center overflow-y-auto">
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-forest focus:border-forest text-gray-900 bg-white"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Devpost Link <span className="text-gray-400 font-normal">(Optional)</span>
                </label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-forest focus:border-forest text-gray-900 bg-white"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"
                  >
                    <span className="material-icons-outlined text-lg">{showConfirmPassword ? 'visibility' : 'visibility_off'}</span>
                  </button>
                </div>
              </div>
